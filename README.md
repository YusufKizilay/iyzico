...
class displays "Connection is not available, request timed out after 30005ms." errorCode after some time.)
...
* In case of an errorCode, there should not be any dirty data in the database.
